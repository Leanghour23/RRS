...
@section('title', 'StaySphere | Dashboard')
...
@push('head')
    <style>
        ...
        .admin-card.strong { background: linear-gradient(135deg, var(--secondary), #cf815e); }
        ...
        .admin-row { padding: 16px 0; border-top: 1px solid rgba(35,83,71,0.08); align-items: flex-start; }
        ...
        @media (max-width: 780px) { .admin-stats, .admin-grid, .admin-menu { grid-template-columns: 1fr; } .admin-topbar, .admin-profile, .admin-panel-head, .admin-row { flex-direction: column; align-items: flex-start; } .admin-main { padding: 18px; } }
    </style>
@endpush
