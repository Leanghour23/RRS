...
@section('title', 'Stay Safe Here | Add Room')
...
@push('head')
    <style>
        ...
        .admin-form-card { max-width: 920px; border-radius: 24px; background: rgba(255,250,244,0.95); box-shadow: 0 22px 46px rgba(27,29,37,0.07); padding: 24px; }
        ...
        .admin-field input, .admin-field select, .admin-field textarea { width: 100%; padding: 14px 16px; border-radius: 16px; border: 1px solid rgba(35,83,71,0.16); background: rgba(255,255,255,0.82); color: var(--text); outline: none; }
        .admin-field input:focus, .admin-field select:focus, .admin-field textarea:focus { border-color: rgba(191,109,77,0.7); box-shadow: 0 0 0 4px rgba(191,109,77,0.12); }
        .admin-input-group { display: grid; grid-template-columns: minmax(0, 1fr) auto; align-items: center; border: 1px solid rgba(35,83,71,0.16); border-radius: 16px; background: rgba(255,255,255,0.82); overflow: hidden; }
        ...
        .admin-input-suffix { padding: 14px 16px; color: var(--muted); background: rgba(35,83,71,0.05); border-left: 1px solid rgba(35,83,71,0.12); font-weight: 700; }
        ...
        .admin-error { margin-bottom: 18px; padding: 14px 16px; border-radius: 16px; background: rgba(191, 109, 77, 0.12); color: #a34f2d; border: 1px solid rgba(191, 109, 77, 0.18); }
    ...
    <div class="admin-shell">
        ...
        <section class="admin-main">
            <div class="admin-topbar">
                <div>
                    <h1 class="admin-title">Add Room</h1>
                    <p class="admin-subtle">Create a new room listing for the inventory.</p>
                </div>
            ...
            <article class="admin-form-card">
                ...
                <form method="POST" action="{{ route('admin.rooms.store') }}" enctype="multipart/form-data" class="admin-form-grid">
                    @csrf
                    ...
                    <div class="admin-form-row">
                        <div class="admin-field">
                            ...
                            <input id="room_type" name="room_type" type="text" value="{{ old('room_type') }}" placeholder="Private room, studio, shared room">
                        </div>
                        <div class="admin-field">
                    ...
                    <div class="admin-form-row">
                        ...
                        <div class="admin-field">
                            ...
                            <input id="deposit" name="deposit" type="number" step="0.01" min="0" value="{{ old('deposit', 0) }}">
                        </div>
                    </div>
                    ...
                    <div class="admin-form-row">
                        <div class="admin-field">
                            ...
                            <div class="admin-input-group">
                                <input id="price_period" name="price_period" type="number" min="1" value="{{ old('price_period', 1) }}" required>
                                <span class="admin-input-suffix">month</span>
                            </div>
                        </div>
                        <div class="admin-field">
                            <label for="available_from_label">Available From</label>
                            <input id="available_from_label" name="available_from_label" type="text" value="{{ old('available_from_label') }}" placeholder="Available now">
                        </div>
                    </div>
                    ...
                    <div class="admin-form-row">
                        <div class="admin-field">
                            ...
                            <input id="capacity_label" name="capacity_label" type="text" value="{{ old('capacity_label') }}" placeholder="2 guests">
                        </div>
                        <div class="admin-field">
                            <label for="size_label">Size</label>
                            <input id="size_label" name="size_label" type="text" value="{{ old('size_label') }}" placeholder="28 sqm">
                        </div>
                    </div>
                    ...
                    <div class="admin-form-row">
                        <div class="admin-field">
                            ...
                            <input id="bathroom" name="bathroom" type="text" value="{{ old('bathroom') }}" placeholder="Private bathroom">
                        </div>
                        <div class="admin-field">
                            <label for="furnishing">Furnishing</label>
                            <input id="furnishing" name="furnishing" type="text" value="{{ old('furnishing') }}" placeholder="Fully furnished">
                        </div>
                    </div>
                    ...
                    <div class="admin-form-row">
                        <div class="admin-field">
                            ...
                            <input id="theme" name="theme" type="text" value="{{ old('theme') }}" placeholder="minimal, oakwood, skyline">
                        </div>
                        <div class="admin-field">
                            <label for="availability_label">Availability Label</label>
                            <input id="availability_label" name="availability_label" type="text" value="{{ old('availability_label') }}" placeholder="1 room left">
                        </div>
                    </div>
                    ...
                    <div class="admin-form-row">
                        ...
                        <div class="admin-field">
                            ...
                            <input id="utilities_label" name="utilities_label" type="text" value="{{ old('utilities_label') }}" placeholder="Wi-Fi, water, electricity">
                        </div>
                    </div>
                    ...
                    <div class="admin-form-row">
                        <div class="admin-field">
                            ...
                            <input id="visit_label" name="visit_label" type="text" value="{{ old('visit_label') }}" placeholder="Schedule a visit anytime">
                        </div>
                        <div class="admin-field">
                            <label for="contract_label">Contract</label>
                            <input id="contract_label" name="contract_label" type="text" value="{{ old('contract_label') }}" placeholder="6-month minimum stay">
                        </div>
                    </div>
                    ...
                    <div class="admin-form-row">
                        <div class="admin-field">
                            ...
                            <textarea id="description" name="description" rows="4" placeholder="Short room summary">{{ old('description') }}</textarea>
                        </div>
                        <div class="admin-field">
                            <label>&nbsp;</label>
                            <p class="admin-subtle">Upload JPG, PNG, WEBP, or GIF up to 5 MB. If no photo is uploaded, the room theme background will still be used.</p>
                        </div>
                    </div>
                    ...
                    <div class="admin-actions">
                        <button type="submit" class="button-link">Save Room</button>
